...
namespace XamarinFC.Droid.Services
{
    ...
    {
        public static string[] SENDER_IDS = new string[] { "1028944799294" };
    }

    [Service]
    public class GcmService : GcmServiceBase
    {
        private readonly MobileServiceClient _client = new MobileServiceClient("https://xamarin-marathon-intermediate.azurewebsites.net/");
        ...
        private void CreateNotification(string title, string desc)
        {
            ...
            // We use the pending intent, passing out ui intent over which will get called
        ...
        {
            Log.Verbose("PushHandlerBradcastReceiver", "GCM Registered: " + registrationId);
